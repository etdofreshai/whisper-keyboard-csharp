...
public class AudioProcessor : IDisposable
{
    ...
    public void AdjustVadThreshold(int delta)
    {
        _config.VadThreshold = Math.Max(1000, Math.Min(100000, _config.VadThreshold + delta));
    }

    public void AdjustMinAudioDuration(double delta)
    {
        _config.MinAudioDuration = Math.Max(0.5, Math.Min(10.0, _config.MinAudioDuration + delta));
    }
